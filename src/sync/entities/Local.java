    ...
    public ArrayList<Object> listar(String idParam, Object type) {
        ...
        try {
            if(type instanceof Ficha){
                ...
                String sqlFicha="SELECT fch_id, fch_fecha, fch_fecha_entrega, fch_lugar_entrega, fch_hora_entrega,"
                ...
                + "from ficha f  where f.fch_id='"+idParam+"' and f.user_us_id='"+idParam+"' and f.fch_estado <> 0";

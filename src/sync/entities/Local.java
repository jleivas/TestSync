...
public class Local implements InterfaceSync{
    ...
    public int getMaxUserId() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        Log.setLog(className,Log.getReg());
    ...
    public int getMaxCristalId() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
        Log.setLog(className,Log.getReg());
    ...
    public int getMaxDescuentoId() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
        Log.setLog(className,Log.getReg());

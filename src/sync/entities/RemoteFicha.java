...
public class RemoteFicha implements InterfaceSyncFicha{
    ...
    public boolean add(Object objectParam) {
        ...
        try{
            if(objectParam instanceof Armazon){
                ...
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT arm_id FROM armazon WHERE arm_id='"+object.getId()+"'");
            ...
            if(objectParam instanceof Despacho){
                ...
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT dsp_id FROM despacho WHERE dsp_id='"+object.getId()+"'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
                    RmBd.cerrar();
                    return update(object);
            ...
            if(objectParam instanceof HistorialPago){
                ...
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT hp_id FROM historial_pago WHERE hp_id='"+object.getId()+"'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
                    RmBd.cerrar();
                    return update(object);
    ...
    public boolean update(Object objectParam) {
        ...
        try{
            if(objectParam instanceof Armazon){
                Armazon object = (Armazon)objectParam;
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT * FROM armazon WHERE arm_id='"+object.getId()+"'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
            ...
            if(objectParam instanceof Despacho){
                Despacho object = (Despacho)objectParam;
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT * FROM despacho WHERE dsp_id='"+object.getId()+"'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
                    Date dsp_fecha= new Date();
                    try {
            ...
            if(objectParam instanceof HistorialPago){
                HistorialPago object = (HistorialPago)objectParam;
                PreparedStatement consulta = RmBd.obtener().prepareStatement("SELECT * FROM historial_pago WHERE hp_id='"+object.getId()+"'");
                ResultSet datos = consulta.executeQuery();
                while (datos.next()) {
                    Date dsp_fecha= new Date();
                    try {
